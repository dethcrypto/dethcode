  ...
  implements IWorkbenchContribution
{
  ...
  private registerGlobalActions(): void {
    ...
    this.registerExtensionAction({
      ...
      title: {
        value: localize("showRecommendedKeymapExtensionsShort", "Keymaps"),
        original: "Keymaps",
      },
    ...
    this.registerExtensionAction({
      ...
      title: {
        value: localize("showLanguageExtensionsShort", "Language Extensions"),
    ...
    this.registerExtensionAction({
      ...
      title: {
        value: localize("checkForUpdates", "Check for Extension Updates"),
    ...
    this.registerExtensionAction({
      ...
      run: (accessor: ServicesAccessor) =>
        accessor
          .get(IConfigurationService)
          .updateValue(AutoUpdateConfigurationKey, "onlyEnabledExtensions"),
    });
    ...
    this.registerExtensionAction({
      ...
      run: () => {
        return Promise.all(
          this.extensionsWorkbenchService.outdated.map(async (extension) => {
            try {
    ...
    this.registerExtensionAction({
      ...
      title: {
        value: localize("disableAll", "Disable All Installed Extensions"),
    ...
    this.registerExtensionAction({
      ...
      title: {
        value: localize("showFeaturedExtensions", "Show Featured Extensions"),
    ...
    this.registerExtensionAction({
      ...
      title: {
        value: localize("showPopularExtensions", "Show Popular Extensions"),
    ...
    this.registerExtensionAction({
      ...
      title: {
        value: localize("showBuiltInExtensions", "Show Built-in Extensions"),
    ...
    this.registerExtensionAction({
      ...
      title: {
        value: localize("showEnabledExtensions", "Show Enabled Extensions"),
    ...
    this.registerExtensionAction({
      ...
      title: {
        value: localize("showDisabledExtensions", "Show Disabled Extensions"),
      ...
      this.registerExtensionAction({
        ...
        run: async () => {
          ...
          extensionsViewPaneContainer.search(
            new Query(currentQuery.value, id, currentQuery.groupBy).toString()
          );
  ...
  private registerContextMenuActions(): void {
    ...
    this.registerExtensionAction({
      ...
      title: {
        value: localize("show pre-release version", "Show Pre-Release Version"),
    ...
    this.registerExtensionAction({
      ...
      title: {
        value: localize("show released version", "Show Release Version"),
    ...
    this.registerExtensionAction({
      ...
      title: {
        value: localize("workbench.extensions.action.copyExtension", "Copy"),
        original: "Copy",
      },
      menu: {
        id: MenuId.ExtensionContext,
