...
registerDebugCommandPaletteItem(
  TERMINATE_THREAD_ID,
  {
    value: nls.localize("terminateThread", "Terminate Thread"),
    original: "Terminate Thread",
  },
  CONTEXT_IN_DEBUG_MODE
);
registerDebugCommandPaletteItem(
...
registerDebugCommandPaletteItem(
  JUMP_TO_CURSOR_ID,
  {
    value: nls.localize("jumpToCursor", "Jump to Cursor"),
    original: "Jump to Cursor",
  },
  CONTEXT_JUMP_TO_CURSOR_SUPPORTED
);
registerDebugCommandPaletteItem(
  JUMP_TO_CURSOR_ID,
  {
    value: nls.localize("SetNextStatement", "Set Next Statement"),
    original: "Set Next Statement",
  },
  CONTEXT_JUMP_TO_CURSOR_SUPPORTED
);
registerDebugCommandPaletteItem(
  RunToCursorAction.ID,
  { value: RunToCursorAction.LABEL, original: "Run to Cursor" },
  CONTEXT_DEBUGGERS_AVAILABLE
);
registerDebugCommandPaletteItem(
  SelectionToReplAction.ID,
  { value: SelectionToReplAction.LABEL, original: "Evaluate in Debug Console" },
  CONTEXT_IN_DEBUG_MODE
);
registerDebugCommandPaletteItem(SelectionToWatchExpressionsAction.ID, {
  value: SelectionToWatchExpressionsAction.LABEL,
  original: "Add to Watch",
});
registerDebugCommandPaletteItem(TOGGLE_INLINE_BREAKPOINT_ID, {
  value: nls.localize("inlineBreakpoint", "Inline Breakpoint"),
...
MenuRegistry.appendMenuItem(MenuId.EditorTitle, {
  ...
  title: {
    value: nls.localize("run", "Run or Debug..."),
    original: "Run or Debug...",
  },
  icon: icons.debugRun,
  group: "navigation",
  order: -1,
