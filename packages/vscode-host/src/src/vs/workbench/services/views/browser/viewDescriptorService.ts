/**
 * Changes:
 * * onDidRegisterViews add if !viewContainer because sometimes it's nullish
 */
  ...
  implements IViewDescriptorService
{
  ...
  constructor(
    ...
    this._register(
      this.viewContainersRegistry.onDidDeregister(({ viewContainer }) => {
  ...
  private getOrRegisterViewContainerModel(
    ...
    if (!viewContainerModel) {
      ...
      this.viewContainerModels.set(viewContainer, {
        viewContainerModel: viewContainerModel,
        disposables,
  ...
  private registerViewsVisibilityActions(): void {
    for (const [viewContainer, { viewContainerModel, disposables }] of this
      .viewContainerModels) {
