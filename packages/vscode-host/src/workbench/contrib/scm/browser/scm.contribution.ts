...
import { DirtyDiffWorkbenchController } from "vs/workbench/contrib/scm/browser/dirtydiffDecorator";
import {
  ISCMRepository,
  ISCMService,
  VIEW_PANE_ID,
...
import { SCMStatusController } from "vs/workbench/contrib/scm/browser/activity";
...
KeybindingsRegistry.registerCommandAndKeybindingRule({
  id: "scm.acceptInput",
  description: {
    description: localize("scm accept", "SCM: Accept Input"),
    args: [],
  },
...
const viewNextCommitCommand = {
  description: {
    description: localize("scm view next commit", "SCM: View Next Commit"),
    args: [],
  },
  weight: KeybindingWeight.WorkbenchContrib,
